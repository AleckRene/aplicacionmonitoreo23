...
$mapeoLikert = [
    'nivel_actividad' => [
        1 => 'Nada activa', 2 => 'Poco activa', 3 => 'Moderadamente activa',
        4 => 'Activa', 5 => 'Muy activa'
    ],
    'frecuencia_recomendaciones' => [
        1 => 'Raramente', 2 => 'Ocasionalmente', 3 => 'Moderadamente frecuente',
        4 => 'Frecuente', 5 => 'Muy frecuente'
    ],
    'calidad_uso' => [
        1 => 'Deficiente', 2 => 'Aceptable', 3 => 'Buena',
        4 => 'Muy buena', 5 => 'Excelente'
    ],
    'grupos_comprometidos' => [
        1 => 'Brigadistas', 2 => 'Líderes locales', 3 => 'Juntas comunitarias',
        4 => 'ONGs locales', 5 => 'Voluntarios'
    ],
    'estrategias_mejora' => [
        1 => 'Capacitaciones', 2 => 'Red de apoyo comunitario', 3 => 'Mayor difusión',
        4 => 'Uso de herramientas digitales', 5 => 'Colaboración con entidades'
    ],
    'area_prioritaria' => [
        1 => 'Salud', 2 => 'Educación', 3 => 'Infraestructura',
        4 => 'Seguridad', 5 => 'Medio ambiente'
    ]
];
...
// Aplicar la consolidación con mapeo
...
$consolidadoEventos = consolidarDatos($eventos_salud, ['nombre_evento', 'descripcion', 'acciones'], $mapeoLikert);
$consolidadoNecesidades = consolidarDatos($necesidades_comunitarias, ['descripcion', 'acciones', 'area_prioritaria'], $mapeoLikert);

// Función para generar tablas en el PDF
...
try {
    ...
    $html = "<html><head><title>Reporte General</title>
