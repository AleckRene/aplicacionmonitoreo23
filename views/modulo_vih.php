...
<body>
    <div class="auth-container">
        <h1>Módulo VIH</h1>
        <p>Bienvenido, <strong><?php echo htmlspecialchars($_SESSION['username']); ?></strong>. Este módulo está dedicado a la gestión y monitoreo de los indicadores relacionados con el VIH.</p>

        <div class="module-buttons">
            <a href="accesibilidad_calidad.php" class="btn">Accesibilidad y Calidad</a>
            <a href="percepcion_servicios.php" class="btn">Percepción de Servicios</a>
        </div>
